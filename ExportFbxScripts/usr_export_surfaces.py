...
objects_to_export = ["Plane16x16"]  # Modify this list as per your needs
blend_file = "../ArtSource/Surfaces.blend"  # Path to your .blend file
export_directory = "../Unity/Quantra/Assets/Core/Fbx/Environment/Ocean"  # Directory to save the FBX files
